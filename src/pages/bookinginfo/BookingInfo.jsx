        ...
        <div className="container header booking">
            <div className='left-container'>
              <div className="booking-info">
                ...
                <div className='brief-info'>
                  <h3>Dr. David Frank</h3>
                  <button>DENTIST</button>
                  <div className='review'>
                    <FaStar color='#ffb116' size={20}/>
                    <span>3.4(5)</span>
                  </div>
                  <h4>Book Date: 26th sept 2024 12:30 pm</h4>
                  <p>Status: <span className='cancelled'>BOOKED</span></p>
            ...
            <div className="right-container">
              <div className="booking-actions">
                <button>CHANGE APPOINTMENT DATE</button>
              ...
              <div className="messages">
                <div className='message-header'>
                  {!toggleForm && <div>
                    <h3>Messages</h3>
                    <button onClick={() => { setToggleForm(true) }}><FaMessage size={20}/></button>
                  </div>}
                  {toggleForm && <form onSubmit={ submitMessage }>
                    <input type="text" placeholder='message' />
                    <button type="submit"><IoSend size={20}/></button>
                  </form>}
                </div>
